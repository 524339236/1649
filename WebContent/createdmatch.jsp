	...
	<fieldset>
		...
		<table class="listtable" width="100%" border="0" cellpadding="0"
			...
			<tr class="listheader">
				...
				<td width="10%" nowrap="nowrap"><div align="center">申请状态
					</div></td>
				...
				<c:otherwise>
					<c:forEach items="${requestScope.matchList }" var="match"
						...
						<tr>
							...
							<td nowrap="nowrap"><div align="center">${match.matchStatus }</div></td>
							<td nowrap="nowrap"><div align="center">
									<c:choose>
										...
										<c:otherwise>
											...
											| <a
														href="changematchdetail.do?op=reapply&mid=${match.matchId }">再次申请✔</a>
												</c:when>
											</c:choose>
