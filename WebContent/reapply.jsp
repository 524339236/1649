...
<body>
	...
	%>
	<!--注册表单-->
	<form id="reapplyForm" action="reapply.do" method="post">
		<input type="hidden" id="mid" name="mid" value="<%=mmid %>">
		
		<fieldset>
			<legend>重新申请比赛</legend>
			<table align="center" class="page-content">
				...
				%>
				<tr>
					<td><label for="matchname" class="xrequired">MatchName:</label></td>
					<td><p id="matchname">${match.matchName }</p>
						<input type="hidden" name="matchname" value="${match.matchName }"></td>
				...
				<tr>
					...
					<td><input type="radio" name="matchtype" value="0" checked >公有比赛
					    <input type="radio" name="matchtype" value="1" >私有比赛</td>
				</tr>
				<tr>
					<td><label class="xrequired">比赛赛制:</label></td>
					<td><select id="matchsystem" name="matchsystem"
						aria-placeholder="--请选择--">
							<option value=${match.matchSystem }>${match.matchSystem }</option>
				...
				<tr>
					...
					<td><input type="date" id="matchstarttime" min="2021-01-01"
						name="matchstarttime" value=${match.matchStartTime } required></td>
				</tr>
				<tr>
					<td><label class="xrequired">比赛结束时间:</label></td>
					<td><input type="date" id="matchendtime" min="2021-05-26"
						name="matchendtime" value=${match.matchEndTime } required></td>
				</tr>
				<tr>
					<td><label class="xrequired">人数/队伍上限:</label></td>
					<td><input type="text" id="matchnumber" name="matchnumber"
						placeholder="人数/队伍上限" value=${match.matchNumber }></td>
				</tr>
				<tr>
					<td>比赛介绍:</td>
					<td><textarea id="matchinfo" name="matchinfo"
							placeholder="请输入比赛的相关介绍">${match.matchInfo }</textarea></td>
				</tr>

				<tr>
					<td><input type="submit" class="submit" value="再次申请🛏😁"></td>
